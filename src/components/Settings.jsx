...
// //         alert("ഫയൽ സൈസ് 2MB-യിൽ കൂടരുത്!");
// //         return;
// //       }
...
// //       if (file.size > 2 * 1024 * 1024) {
// //         alert(`${file.name} 2MB-യിൽ കൂടുതലാണ്, അത് ഒഴിവാക്കി.`);
// //         return false;
// //       }
// //       return true;
// //     });
...
// //       setMessage({ type: "success", text: "മാറ്റങ്ങൾ വിജയകരമായി സേവ് ചെയ്തു!" });
...
// //       });
// //     } catch (err) {
// //       console.error("Save ചെയ്യാൻ സാധിച്ചില്ല", err);
// //       console.error("Error Response:", err.response?.data);
// //       setMessage({ type: "error", text: err.response?.data?.error || "സേവ് ചെയ്യുന്നതിൽ പരാജയം! വീണ്ടും ശ്രമിക്കുക." });
// //     } finally {
// //       setSaving(false);
// //     }
// //   };
...
// //   if (loading) {
// //     return <div className="home-loading">Settings loading.....</div>;
// //   }
...
//   // ✅ Empty string ആണെങ്കിൽ append ചെയ്യരുത്
//   const appendIfNotEmpty = (key, value) => {
//     if (value !== null && value !== undefined && value !== "") {
//       formData.append(key, value);
//     }
...
//                   <img
//                     src={previewUrl || profileData.profilePic || "https://via.placeholder.com/150"}
//                     alt="Profile"
//                     style={{ width: "100%", height: "100%", objectFit: "cover", display: "block" }}
//                     onError={(e) => {e.target.src = 'https://via.placeholder.com/150'}}
//                   />
//                   <label htmlFor="file-input" className="upload-icon" style={{ cursor: "pointer" }}>
//                     📷
//                   </label>
//                   <input id="file-input" type="file" accept="image/*" onChange={handleFileChange} style={{ display: "none" }} />
//                 </div>

//                 <label htmlFor="file-input" className="upload-btn" style={{ cursor: "pointer", display: "inline-block", textAlign: "center" }}>
//                   Upload New Photo
//                 </label>
...
//                   <label htmlFor="gallery-input" className="upload-btn" style={{ cursor: "pointer", display: "block", textAlign: "center", backgroundColor: "#f0f0f0", color: "#333", border: "1px dashed #ccc" }}>
//                     + Add Gallery Photos
//                   </label>
...
//                       <p style={{ fontSize: "12px", color: "#666" }}>പുതിയ ചിത്രങ്ങൾ (സേവ് ചെയ്തിട്ടില്ല):</p>
...
//                             <button type="button" onClick={() => removeSelectedGalleryImage(index)} style={{ position: "absolute", top: "-5px", right: "-5px", background: "red", color: "white", border: "none", borderRadius: "50%", width: "18px", height: "18px", fontSize: "10px", cursor: "pointer", display: "flex", alignItems: "center", justifyContent: "center" }}>✕</button>
//                           </div>
//                         ))}
//                       </div>
//                     </div>
...
//                       <p style={{ fontSize: "12px", color: "#666" }}>സേവ് ചെയ്ത ചിത്രങ്ങൾ ({profileData.galleryImages.length}):</p>
//                       <div style={{ display: "flex", gap: "8px", flexWrap: "wrap", marginTop: "5px" }}>
...
//                   <input type="email" name="email" value={profileData.email} disabled style={{ backgroundColor: "#f5f5f5", cursor: "not-allowed" }} />
//                 </div>

//                 <div className="form-group">
//                   <label>Phone Number</label>
//                   <input type="text" name="phone" value={profileData.phone} onChange={handleChange} placeholder="Phone Number" />
//                 </div>
...
//                 <div className="form-group">
//                   <label>Height</label>
//                   <input type="text" name="height" value={profileData.height} onChange={handleChange} placeholder="5'6 or 168 cm" />
//                 </div>
...
//                   <input type="text" name="religion" value={profileData.religion} onChange={handleChange} placeholder="Religion" />
//                 </div>

//                 <div className="form-group">
//                   <label>Caste</label>
//                   <input type="text" name="caste" value={profileData.caste} onChange={handleChange} placeholder="Caste" />
//                 </div>

//                 <div className="form-group">
//                   <label>Mother Tongue</label>
//                   <input type="text" name="motherTongue" value={profileData.motherTongue} onChange={handleChange} placeholder="Mother Tongue" />
//                 </div>

//                 <h3>Education & Career</h3>
//                 <div className="form-group">
//                   <label>Education</label>
//                   <input type="text" name="education" value={profileData.education} onChange={handleChange} placeholder="Highest Education" />
//                 </div>

//                 <div className="form-group">
//                   <label>Profession/Occupation</label>
//                   <input type="text" name="profession" value={profileData.profession} onChange={handleChange} placeholder="Your Profession" />
//                 </div>

//                 <div className="form-group">
//                   <label>Company</label>
//                   <input type="text" name="company" value={profileData.company} onChange={handleChange} placeholder="Company Name" />
//                 </div>

//                 <div className="form-group">
//                   <label>Annual Income</label>
//                   <input type="text" name="annualIncome" value={profileData.annualIncome} onChange={handleChange} placeholder="Annual Income" />
//                 </div>

//                 <h3>Location</h3>
//                 <div className="form-group">
//                   <label>Country</label>
//                   <input type="text" name="country" value={profileData.country} onChange={handleChange} placeholder="Country" />
//                 </div>

//                 <div className="form-group">
//                   <label>State</label>
//                   <input type="text" name="state" value={profileData.state} onChange={handleChange} placeholder="State" />
//                 </div>

//                 <div className="form-group">
//                   <label>District</label>
//                   <input type="text" name="location" value={profileData.location} onChange={handleChange} placeholder="District" />
//                 </div>

//                 <div className="form-group">
//                   <label>City</label>
//                   <input type="text" name="city" value={profileData.city} onChange={handleChange} placeholder="City" />
//                 </div>

//                 <h3>Family Details</h3>
//                 <div className="form-group">
//                   <label>Father's Name</label>
//                   <input type="text" name="fatherName" value={profileData.fatherName} onChange={handleChange} placeholder="Father's Name" />
//                 </div>

//                 <div className="form-group">
//                   <label>Mother's Name</label>
//                   <input type="text" name="motherName" value={profileData.motherName} onChange={handleChange} placeholder="Mother's Name" />
//                 </div>

//                 <div className="form-group">
//                   <label>Family Type</label>
//                   <select name="familyType" value={profileData.familyType} onChange={handleChange}>
//                     <option value="">Select</option>
...
//                   <input type="text" name="siblings" value={profileData.siblings} onChange={handleChange} placeholder="Eg: 1 Brother, 1 Sister" />
//                 </div>

//                 <h3>About</h3>
//                 <div className="form-group">
//                   <label>About Me</label>
//                   <textarea name="aboutMe" rows="4" value={profileData.aboutMe} onChange={handleChange} placeholder="Tell us about yourself..." />
//                 </div>
//               </div>
//             </div>
//           </form>
...
// //           phone: profile.phone || "",
// //           dob: profile.dob || "",
// //           gender: profile.gender === "f" || profile.gender?.toLowerCase() === "female" ? "Female" : "Male",
// //           location: profile.district || profile.location || "",
// //           bio: profile.bio || "",
// //           profilePic: profile.profile_picture ? `${API_BASE_URL}${profile.profile_picture}` : ""
// //         });
// //       } catch (err) {
// //         console.error("Profile load ചെയ്യാൻ സാധിച്ചില്ല", err);
// //         setMessage({ type: "error", text: "വിവരങ്ങൾ ലോഡ് ചെയ്യുന്നതിൽ പരാജയം. ദയവായി ലോഗിൻ ചെയ്യുക." });
...
// //     formData.append("gender", profileData.gender.toLowerCase() === "female" ? "female" : "male");
// //     formData.append("district", profileData.location); 
...
// //     } catch (err) {
// //       console.error("Save ചെയ്യാൻ സാധിച്ചില്ല", err);
// //       setMessage({ type: "error", text: "സേവ് ചെയ്യുന്നതിൽ പരാജയം! വീണ്ടും ശ്രമിക്കുക." });
// //     } finally {
// //       setSaving(false);
// //     }
// //   };
...
// //           </form>
// //         ) : (
// //           <div className="settings-content" style={{ flex: 1, padding: "40px", textAlign: "center", color: "#666" }}>
// //             <h3>ഈ ഭാഗം നിർമ്മാണത്തിലാണ്...</h3>
// //           </div>
// //         )}
// //       </div>

...
const PersonalDetails = ({ formData, handleInputChange, handleFinalSubmit, handleBack, loading, setFormData }) => {
  ...
  const handleInterestToggle = (interest) => {
    ...
    // ഫേം ഡാറ്റ അപ്ഡേറ്റ് ചെയ്യുന്നു
    if (setFormData) {
  ...
  return (
    <div className="form-container">
      ...
      <form onSubmit={handleFinalSubmit}>
        ...
        {/* ✨ പുതിയ INTERESTS TAG SELECTION സെക്ഷൻ */}
...
// const PersonalDetails = ({ formData, handleInputChange, handleFinalSubmit, handleBack, loading }) => {
//   const familyTypeOptions = [
//     { value: 'nuclear', label: 'Nuclear Family' },
//     { value: 'joint', label: 'Joint Family' },
//     { value: 'single_parent', label: 'Single Parent Family' },
...
//             options={familyTypeOptions}
//             value={familyTypeOptions.find(opt => opt.value === formData.family_type)}
//             onChange={(opt) => handleInputChange({ target: { name: 'family_type', value: opt.value } })}
//             placeholder="Select Family Type"
//             styles={selectStyles}
//             menuPortalTarget={document.body}
//             isClearable
